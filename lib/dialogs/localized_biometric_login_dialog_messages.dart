...
class LocalizedBiometricLoginDialogMessages extends DialogMessages {
  LocalizedBiometricLoginDialogMessages()
      : super(
          hint: S.current.biometricHint,
          notRecognized: S.current.biometricNotRecognized,
          success: S.current.biometricSuccess,
          cancel: S.current.biometricLoginCancel,
          ...
          cancelButton: S.current.biometricLoginCancel,
        );
}
